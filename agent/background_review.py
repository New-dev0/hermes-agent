...
_MEMORY_REVIEW_PROMPT = (
    ...
    "For relationship-style chat, assistant-stated durable opinions also matter: "
    "if you made a strong take, ranking, recommendation, joke, phrase, ritual, "
    "or pushback that future turns should not contradict, preserve it compactly. "
    "If the user corrected that take, save the correction as the stronger "
    "continuity signal.\n\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "preferences with the memory tool. In relationship-style chat, also "
    "preserve assistant-stated durable opinions, rankings, jokes, phrases, "
    "rituals, and pushback when future turns should stay consistent with them. "
    "If the user corrected a prior take, save the correction as stronger than "
    "the older take.\n\n"
